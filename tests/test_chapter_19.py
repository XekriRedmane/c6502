...
_C6502_OVERRIDES: dict[str, int] = {
    ...
    "constant_folding/all_types/fold_truncate.c": 3,
    ...
    "copy_propagation/all_types/propagate_all_types.c": 0,
    "dead_store_elimination/all_types/dont_elim/recognize_all_uses.c": 3,
    "whole_pipeline/all_types/extra_credit/fold_compound_assign_all_types.c": 1,
    ...
    "whole_pipeline/all_types/fold_cast_from_double.c": 1,
